...
/** A total of 10 mask parameter */
uint8_t Mask[10];
/** All Round key correctly masked */
...
void init_masked_round_keys(){
	...
	//	10th Round key Mask m1'-m4' to Mask m
